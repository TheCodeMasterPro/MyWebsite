...
<body>
    <div class="container">
        <div class="row">
            <div class="col-sm-12"><br /><br /><h1>ניהול משתמשים</h1><br /><br /><br /></div>
         </div>
         <div class="row">
             <form action="" method="post">
                <button type="submit" class="btn btn-danger" name="updateUsers">עדכן פרטים</button>
                <br /><br />
                <table id="customers">
                    <tr>
                        <%--<th>עדכון פרטים</th>--%>
                        ...
                        <th>אימייל</th>
                        <th>שם</th>
                        <th><button type="submit" class="btn btn-danger" name="deleteUsers"><div class="icon">🗑️</div></button></th>
                    </tr>
                    <%=usersTable %>
                </table>
            </form>
