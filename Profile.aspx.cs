...
public partial class UserDetails : System.Web.UI.Page
{
    ...
    {
        string ourSongs = "<a href='#'><div class='item'>השירים שלנו</div></a>";
        ...
        if (Session["user"] == null)
        {
            ...
            Response.Write($"<div class='navBar'><div class='left'>{leftItem}</div><div class='right'>{members}{about}{ourSongs}{logo}</div></div>");
        }
        else
        {
            ...
            if (user.GetIsAdmin() == true)
            {
                ...
                Response.Write($"<div class='navBar'><div class='left'>{profile}{manager}</div><div class='right'>{members}{about}{ourSongs}{logo}</div></div>");
            }
            else
            {
                Response.Write($"<div class='navBar'><div class='left'>{profile}</div><div class='right'>{members}{about}{ourSongs}{logo}</div></div>");
            }
        }
    }
}